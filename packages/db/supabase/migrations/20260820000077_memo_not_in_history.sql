-- ═════════════════════════════════════════════════════════════
-- 0077 · 메모는 수정 내역에 남기지 않는다
--
-- 사장님: "식재료 수정에 메모는 포함되지 말아야 해"
--
-- 수정 내역은 **왜 값이 바뀌었나**를 답하는 자리다. 메모는 어느 계산에도
-- 들어가지 않는 자유 기록이라, 거기 섞이면 진짜 변경을 밀어낸다.
-- 화면이 최근 7일만 보여 주므로 한 줄이 아깝다.
--
-- 메모 자체는 그대로 저장된다(0071). 바뀌었다는 사실은 updated_at 이 가진다.
--
-- ⚠ 식재료·레시피 **둘 다** 뀜다. 한쪽만 빼면 같은 일을 했는데
--   한쪽은 남고 한쪽은 안 남는다.
-- ═════════════════════════════════════════════════════════════
