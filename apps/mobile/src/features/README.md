...
| `ingredients`  | RCP-13b   | 통합 재료 관리 (현재 재료 전체 재고 관리; 이름·카테고리·기준 단가, 등록·수정·삭제 연결)                                                                                                                                  | `recipes/ingredients` (`IngredientManageScreen`)                          | ✅                                      |
| `recipes`      | RCP-13c   | 메뉴·통합 재료 카테고리·목록 편집 (드래그·삭제·저장 확인)                                                                                                                                                                | `recipes/manage-order` (`ManagementOrderScreen`)                          | ✅                                      |
| `recipes`      | RCP-13d   | 메뉴 관리 (식재료 관리 공통 스타일·상세·수정·정렬)                                                                                                                                                                       | `recipes/manage` (`RecipeManageScreen`)                                   | ✅                                      |
...
| `my`           | MY-03a    | 카테고리 수정                                                                                                                                                                                                            | `my/category` (`MyCategoryScreen`)                                        | ✅                                      |
...
| `sales`        | SALES-05b | 판매 수량 입력 (매장/배달/포장 + **조리 후 폐기**) → 작성 완료 시 **E10/E8**                                                                                                                                             | `sales/write` (`SalesDraftWriteScreen` 시트)                              | ✅                                      |
...
| `my`           | MY-12     | 국가·통화 확인 및 설정 (시장 프로필 판본 저장)                                                                                                                                                                           | `my/country` (`MyCountryScreen`)                                          | ✅                                      |
...
- `MY-12`: 국가·통화·업무 로케일·가격 기준과 이관/확인 상태를 서버 계약으로 표시한다
...
| `master-data/hooks`         | `settings_lists` · 카테고리·구매처·채널 저장 함수                                                                                 | 식재료·메뉴·MY 관리 화면                                  |
...
· `save_category` · `save_vendor` · `save_channel` · `save_fixed_costs` · `save_sale`.
