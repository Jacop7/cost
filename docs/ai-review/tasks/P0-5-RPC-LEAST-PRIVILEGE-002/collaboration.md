# P0-5-RPC-LEAST-PRIVILEGE-002 공동 작업 장부

> 001은 외부 호출 전에 Windows 작업 파일 해시를 넣어 Git blob 해시 대조에서 실패했다. 그 task와
> 수동 턴은 보존하고, 이 새 Task는 target commit의 AGENTS blob bytes로 다시 봉인한다.
