# P1-1-ACL-SUPPORT-SOURCE-003 공동 작업 장부

> P1-1 지원 시험의 마지막 필수 Finding 3건과 Improvement 1건을 반영한
> 확정 commit과 실체화된 독립 증거 파일을 보안 재검수한다.
...
- artifact_hashes: `[{ path: packages/db/scripts/admin-acl-audit.test.mjs, sha256: 380afade0352ace4165f52487b701bac037b4575400cc5843b2b6407cd0a6575, change_type: MODIFIED }]`
- evidence_hashes: `[{ path: docs/ai-review/evidence/P1-1-ACL-SUPPORT-SOURCE-002.md, sha256: 1c58a3a3f9200b02b4808791da94980deff1a09579d163b40dfb6906ac0109a5 }]`
- 근거 Finding: `P1-1-SUPPORT-002-EVIDENCE-NOT-MATERIALIZED`, `P1-1-SUPPORT-002-MIGRATIONS-ZERO-AMBIGUOUS`, `P1-1-SUPPORT-002-RPC-SCAN-EVASION`, `P1-1-SUPPORT-002-DEBT-VALUE-PARSING`
- 실행 결과: 사보타주는 모두 exit 1, 복구 후 `corepack pnpm verify` 6/6 exit 0, `fresh_*` 0개.
- 사람 결정 유지: 호스티드 audit와 32/87 권한 축소는 별도 P0-5 R3이다.
