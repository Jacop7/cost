# PROTOTYPE-TERMINOLOGY-001 공동 작업 장부

> 사용자 노출 용어 `메뉴` 통일안과 글로벌 현지화 의미 키를 읽기 전용으로 독립 검수한다.
...
- 결정: 사용자는 메뉴/레시피 용어 통일과 글로벌 현지화 기준을 Fable이 읽기 전용으로 검수하도록 지시했고, 방금 제시된 r001 USD 2.00 소프트캡으로 진행하도록 승인했다.
