(function(){
  const roleSelectors={
    card:'.card,.expo-list-card,.business-card,.change-overview,.stock-check-card,.profit-detail-card,.channel-profit-card,.revenue-card,.sales-menu-card',
    ...
    'choice-row':'.expo-pick-card,.prototype-sheet-row,.past-row,.option-link-item,.sheet-choice',
    ...
    'filter-chip':'.condition-filter,.recipe-filter,.chip',
    'picker-option':'.filter-option',
    'scroll-tabs':'.tabs',
    ...
    button:'.primary,.expo-fab,.sales-add,.order-button,.filter-apply,.empty-action,.edit-menu-close,.option-card-action,.confirm-cancel,.confirm-delete,.recipe-add-search',
    primary:'.primary,.expo-fab,.sales-add,.order-button,.filter-apply',
    'icon-button':'.header-icon,.expo-icon-button,.prototype-sheet-close,.back,.row-more',
